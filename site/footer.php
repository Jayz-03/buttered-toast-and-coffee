        ...
        <div class="row section-header" data-num="03">
            ...
            <div class="column lg-6 stack-on-1100 section-header__primary">
                <h2 class="title text-display-1">
                    "Have any questions or need to place an order? Contact us, and we’ll be happy to assist with
                    anything you need!" <br> <a href="mailto:#0" title="">butteredtoast.info@gmail.com</a>
                </h2>
            </div>
            <div class="column lg-6 stack-on-1100 section-header__secondary">
                ...
                <div class="contact-block">
                    ...
                    <p>
                        Mars Street, Golden Country Subd. <br>Alangilan Batangas City, Batangas City, <br>Philippines,
                        4200
                    </p>
                </div>
        ...
        <div class="row list-block block-lg-one-half block-tab-whole block-stack-on-1000 s-footer__btns">
            <div class="column list-block__item">
                <div class="s-footer__contact-btn">
                    <a href="https://www.facebook.com/messages/t/115330504785562" class="btn btn--primary u-fullwidth" target="_blank">
                        Let's Talk via Messenger Chat
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="row s-footer__bottom">
        <div class="column lg-6 tab-12 s-footer__bottom-left">
            <ul class="s-footer__social">
                <li>
                    <a href="https://www.facebook.com/ButteredToastAndCoffeeAlangilan" target="_blank">
                ...
                <li>
                    <a href="https://www.instagram.com/butteredtoast.btg?igsh=eXRkdjZrenRmZ2s4" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            style="fill:rgba(0, 0, 0, 1);transform:;-ms-filter:">
                            <path
        ...
        <div class="column lg-6 tab-12 s-footer__bottom-right">
            <div class="ss-copyright">
                <span>© Copyright Buttered Toast & Coffee 2024</span>
                <span>Located at <a href="#">Mars Street, Golden Country Subd. Alangilan Batangas City, Batangas City,
                        Philippines, 4200</a> </span>
            </div>
        </div>
